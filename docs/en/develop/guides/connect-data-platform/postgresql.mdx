  ...
  <Tab title="Cloud">
    <Steps>
      ...
      <Step title="Enter PostgreSQL Credentials">
        ...
        | `Password`       | Enter the database user's password.      | ✅        | `mypassword`                 |
  ...
  <Tab title="Local">
    <Steps>
      <Step title="Run the `morph init` Command">
        ...
        The `connections.yml` file is saved as follows. If you create other connections, they will be added under `connections`.
        ```bash shell
        ...
        ```yaml
        connections:
          postgresql-connection: # connection name
