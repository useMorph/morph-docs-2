...
1. The user provides instructions for the data pipeline they want to build as an AI prompt.
2. Based on these instructions, Morph AI plans the SQL and Python files and their processes that should be included in the data pipeline.
