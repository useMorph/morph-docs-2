...
| `variables` | Variable | Variables to pass to the Python function or SQL file. Declare using the variable function. |
...
```tsx
<Metrics alias="aggregate_py" />
```

| Property | Type | Description |
| --- | --- | --- |
| `column` | string | Column name of the value to display |
