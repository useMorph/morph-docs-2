...
<CardGroup cols={1}>
  <Card title="Google Analytics Conversion Analysis" icon="square-1" href="/sample-data-app/ja/google-analytics-conversion">
    Google Analyticsのデータを分析して、Webサイト訪問者がコンバージョンするまでにどのサイトを経由したのか分析します。
  </Card>
</CardGroup>
