...
<video
  ...
  playsInline
>
  <source src="/assets/docs/docs_connection_bigquery.mp4" type="video/mp4" />
</video>
...
![BigQuery Slug](/assets/docs/bigqueryslug.png)

Connections一覧に接続設定が表示されたら設定完了となります。

![BigQuery Complete](/assets/docs/bigquerycomplete.png)