...
<video
  ...
  playsInline
>
  <source src="/assets/docs/docs_connection_snowflake.mp4" type="video/mp4" />
</video>
...
![Snowflake Slug](/assets/docs/snowflakeslug.png)

Connections一覧に接続設定が表示されたら設定完了となります。

![Snowflake Complete](/assets/docs/snowflakecomplete.png)