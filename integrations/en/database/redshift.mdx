...
<video
  ...
  playsInline
>
  <source src="/assets/videos/integrations/docs_connection_redshift.mp4" type="video/mp4" />
</video>
...
![Redshift Slug](/assets/images/integrations/redshiftslug.png)

Connections一覧に接続設定が表示されたら設定完了となります。

![Redshift Complete](/assets/images/integrations/redshiftcomplete.png)