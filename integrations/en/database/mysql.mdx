...
This chapter explains how to link MySQL as an external data source to the Morph platform.
...
<video
  ...
  playsInline
>
  <source src="/assets/videos/integrations/docs_connection_mysql.mp4" type="video/mp4" />
</video>

To set up a connection to MySQL, open the Connection Settings modal from the Connections tab on the Home screen, click the Create New Connection button and select MySQL.
...
![MySQL Slug](/assets/images/integrations/mysqlslug.png)

When the connection settings appear in the Connections list, the configuration is complete.

![MySQL Complete](/assets/images/integrations/mysqlcomplete.png)